...
>(({ title, titleRef, ingredients, ingredientsCounters }, ref) => (
  <>
    <h3 className='text text_type_main-medium mt-10 mb-6' data-cy="burger-ingredients_section" ref={titleRef}>
      {title}
    </h3>
    <ul className={styles.items} ref={ref} data-cy='ingredients-module'>
