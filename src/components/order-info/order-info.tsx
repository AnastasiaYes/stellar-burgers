...
import { clearOrderData, fetchOrderByNumber, selectOrderData } from '../../services/slices/orderSlice';
...
export const OrderInfo: FC = () => {
  ...
  const ingredients: TIngredient[] = useSelector((state) => selectIngredients(state.ingredient));
